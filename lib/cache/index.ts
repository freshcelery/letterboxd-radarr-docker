...
export const get = <T = any>(key: string): Promise<T> => new Promise((resolve, reject) => {
...
export const set = (key: string, value: any, ttl?: number): Promise<void> => new Promise((resolve, reject) => {
